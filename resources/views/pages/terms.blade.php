<x-app-layout>
    ...
    <div class="container content mt-36">
        ...
        <p>
            Wenn Sie sich mit Ihrer E-Mail-Adresse für unseren Newsletter angemeldet haben, nutzen wir Ihre EMail-Adresse auch über die Vertragsdurchführung
            hinaus für eigene Werbezwecke, bis Sie sich vom
            Newsletter-Bezug abmelden.
        </p>
        <h4>Daten-Erhebung durch Nutzung von Google-Analytics</h4>
        <p>
            Unsere Webseite benutzt Google-Analytics, einen Webanalysedienst, der Google inc. GoogleAnalytics verwendet sogenannte „Cookies“. Dabei handelt es sich um Dateien, die auf Ihrem
            Computer gespeichert werden und die eine Analyse ihrer Benutzung der Website ermöglichen.
            Erfasst werden Informationen [AUFZÄHLUNG DER VON GOOGLE ANALYTICS ERHOBENEN
            DATENARTEN]. Die durch diese Dateien erzeugten Informationen über die Benutzung unserer
            Webseite werden an Google in den USA übertragen und dort gespeichert. Google nutzt diese
        ...
        <p>
            ...
            verhindert, dass über das auf Websites ausgeführte JavaScript (ga.js, analytics.js und dc.js)
            Aktivitätsdaten mit Google Analytics geteilt werden.
        </p>
        <p>
        ...
        <h4>Auskunfts-, Löschungs- und Widerspruchsrecht sowie Kontaktdaten</h4>
        <p>
        ...
        <address>
            ...
            1160 Wien<br>
            06763352603<br>
            gerhard@poppgerhard.at
        </address>
        <p>
            Wenn Sie bei einzelnen Diensten der Gesellschaft XXX als Nutzer registriert sind, bieten wir Ihnen
            teilweise auch an, die Daten über ein Nutzer-Konto selbst einzusehen und gegebenenfalls zu löschen
            oder zu ändern.
        </p>
        <p>
            ...
            Für alle Webseitenbetreiber, die einen Link zu dieser Seite ihrer jeweiligen Homepage einfügt haben,
            gilt, dass die Textelemente jeder hier enthaltenen Datenschutzerklärung nur beispielhaften
            Charakter haben und keinen Anspruch auf Vollständigkeit, Richtigkeit und Aktualität erheben
            sowie keine individuelle Rechtsberatung ersetzen können. Ein Rechtsberatungsverhältnis oder ein
            sonst irgendwie bindendes Rechtsverhältnis kommt durch die Nutzung dieser Seiten und Inhalte
            nicht zustande. Die Inhalte der Datenschutzerklärung sind selbständig und in Eigenverantwortung
            zu prüfen, ob sie für die jeweiligen Internetangebote oder -dienste zutreffend sind und keine
            Zusagen enthalten, die der Webseitenbetreiber selbst nicht erfüllen kann.“
        </p>
    </div>
</x-app-layout>
